        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('get_admin.home.index') }}">Trang Chủ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.location.index') }}">Địa Điểm</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.category.index') }}" title="Category">Danh Mục</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.user.index') }}" title="Category">Thành Viên</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.room.index') }}" title="Category">Tin Đăng</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.recharge.index') }}" title="Category">Giao dịch nạp tiền</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.recharge_pay.index') }}" title="Category">Giao dịch thanh toán</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('get_admin.article.index') }}" title="Article">Bài viết</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
...
<footer class="footer mt-auto py-3 bg-light">
    <div class="container">
        <span class="text-muted">VietHoang</span>
    </div>
</footer>
