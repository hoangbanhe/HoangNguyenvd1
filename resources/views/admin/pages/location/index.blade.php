...
@section('content')
    ...
    <div class="">
        <form action="" class="row">
            <div class="col-sm-3">
                <input type="text" placeholder="Tên" value="{{ Request::get('n') }}" name="n" class="form-control">
            </div>
            <div class="col-sm-3">
        ...
        <tbody>
            @foreach($locations ?? [] as $item)
                <tr>
                    ...
                    <td scope="row">
                        <a href="{{ route('get_admin.location.update', $item->id) }}" class="text-blue">Sửa</a>
                        <a href="{{ route('get_admin.location.delete', $item->id) }}" class="text-danger">Xóa</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
