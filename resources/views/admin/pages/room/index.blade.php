...
@section('content')
    ...
    <div class="">
        <form action="" class="row">
            {{-- <div class="col-sm-3">
                <input type="text" placeholder="Mã phòng" value="{{ Request::get('n') }}" id="n" class="form-control">
            </div> --}}
            <div class="col-sm-3">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style="margin-bottom: 2px">
                            ...
                            <a href="{{ route('get_admin.room.delete', $item->id) }}" class="text-danger" style="font-size: 13px;text-decoration: none;font-weight: 500"> <i class="fa fa-trash"></i>Xóa</a>
                        </p>
